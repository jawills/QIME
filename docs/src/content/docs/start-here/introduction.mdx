...
To follow the latest developments with QIME, check out the [GitHub repository](https://github.com/jawills/QIME). Additionally, if you need assistance with implementing QIME, and all things Salesforce, reach out to us [here](https://www.g2technologies.com/contact-us).
...
- Prod: https://login.salesforce.com/packaging/installPackage.apexp?p0=04tDo000000HyyZ&isdtp=p1
- Sandbox https://test.salesforce.com/packaging/installPackage.apexp?p0=04tDo000000HyyZ&isdtp=p1
